class UpdateProductListingRequestModel {
  int? serialNo;
  String? medicineName;
  String? genericName;
  ...
  List<PackSizesRequest>? packSizes;
  List<DrugInteractionsRequest>? drugInteractions;
  List<BrandPrescriptionsRequest>? brandPrescriptions;

  UpdateProductListingRequestModel(
      {this.serialNo,
        this.medicineName,
        this.genericName,
        this.manufacturedBy,
  ...
  UpdateProductListingRequestModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['packSizes'] != null) {
      packSizes = <PackSizesRequest>[];
      json['packSizes'].forEach((v) {
        packSizes!.add(new PackSizesRequest.fromJson(v));
      });
    }
    if (json['drugInteractions'] != null) {
      drugInteractions = <DrugInteractionsRequest>[];
      json['drugInteractions'].forEach((v) {
        drugInteractions!.add(new DrugInteractionsRequest.fromJson(v));
      });
    }
    if (json['brandPrescriptions'] != null) {
      brandPrescriptions = <BrandPrescriptionsRequest>[];
      json['brandPrescriptions'].forEach((v) {
        brandPrescriptions!.add(new BrandPrescriptionsRequest.fromJson(v));
      });
    }
  }
...
class PackSizesRequest {
  int? id;
  String? strength;
  String? packSize;
  String? storage;

  PackSizesRequest({this.id, this.strength, this.packSize, this.storage});

  PackSizesRequest.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class DrugInteractionsRequest {
  int? id;
  String? drug;
  String? interaction;

  DrugInteractionsRequest({this.id, this.drug, this.interaction});

  DrugInteractionsRequest.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    drug = json['drug'];
...
class BrandPrescriptionsRequest {
  ...
  BrandPrescriptionsRequest.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    dosage = json['dosage'];
    strength = json['strength'];
    route = json['route'];
