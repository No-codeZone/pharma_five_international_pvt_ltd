class ProductSearchListingResponseModel {
  int? totalCount;
  List<Products>? products;

  ProductSearchListingResponseModel({this.totalCount, this.products});

  ProductSearchListingResponseModel.fromJson(Map<String, dynamic> json) {
