...
class ProductDetailsScreenAdmin extends StatefulWidget {
  final GetProductsContent getProductsContent;

  const ProductDetailsScreenAdmin({Key? key, required this.getProductsContent}) : super(key: key);

  @override
  State<ProductDetailsScreenAdmin> createState() => _ProductDetailsScreenAdminState();
}

class _ProductDetailsScreenAdminState extends State<ProductDetailsScreenAdmin> {
  int? _expandedIndex;
